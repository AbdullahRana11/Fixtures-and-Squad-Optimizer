...
// --------------- HELPERS ---------------
function toStr(val) { return val != null ? String(val).trim() : ''; }
function toFloat(val) { return parseFloat(String(val || 0)) || 0; }
