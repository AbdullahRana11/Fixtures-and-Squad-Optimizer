      ...
      >
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <motion.h2 
            ...
            className="text-5xl lg:text-7xl font-merriweather font-bold text-white mb-6 leading-tight"
          >
            Fixture &<br />
          ...
          <motion.div 
            ...
            className="flex items-center gap-4 text-teal-500 font-semibold group-hover:gap-6 transition-all duration-300"
          >
      ...
      >
        ...
        <div className="relative z-20 max-w-xl">
          ...
          <motion.h2 
            ...
            className="text-4xl lg:text-5xl font-merriweather font-bold text-white mb-6 leading-tight"
          >
