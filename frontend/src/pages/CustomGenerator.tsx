      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <Users className="absolute left-4 top-1/2 -tranzinc-y-1/2 w-4 h-4 text-emerald-400" />
            <input 
  ...
  const renderStep2 = (
    ...
    >
      ...
      <div className="flex justify-between items-center">
        ...
        <button onClick={handleRandomizeTeams} className="px-4 py-2 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-black uppercase flex items-center gap-2 hover:bg-emerald-500 hover:text-black transition-all shadow-[0_0_15px_rgba(45,212,191,0.2)]">
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div 
          ...
          className={`p-6 rounded-3xl border cursor-pointer transition-all flex items-center justify-between ${settings.neutralVenue ? 'bg-emerald-500/10 border-emerald-500 shadow-[0_0_30px_rgba(45,212,191,0.15)]' : 'bg-white/2 border-white/5 hover:border-white/20'}`}
        >
      ...
      <div className="overflow-y-auto space-y-3 pr-2 custom-scrollbar flex-1" style={{ maxHeight: 'max(40vh, 300px)' }}>
        {fixtures.map((f, i) => (
          <motion.div 
            ...
            className="group relative p-6 rounded-3xl tactical-glass border-white/5 hover:border-emerald-500/30 hover:bg-white/[0.03] transition-all overflow-hidden"
          ...
          >
            ...
            <div className="absolute top-0 right-0 h-[2px] bg-emerald-500/20 transition-all group-hover:bg-emerald-500" style={{ width: `${(Math.min(5, f.magnitude || 0)/5) * 100}%` }} />
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-black/40 border border-white/5">
                   {f.isNightMatch ? <Moon className="w-3 h-3 text-emerald-400" /> : <Sun className="w-3 h-3 text-amber-500" />}
              ...
              <div className="flex items-center gap-2">
                 <div className="flex items-center gap-1 px-2 py-1 rounded-md bg-emerald-500/10 border border-emerald-500/10">
                    ...
                    <span className="text-[8px] font-black text-emerald-400 uppercase">{f.conditions.type} • {f.conditions.temp}°C</span>
                 </div>
              </div>
            </div>
            ...
            <div className="mb-4 space-y-1">
               <div className="flex justify-between items-center text-[7px] font-black uppercase tracking-[0.2em] text-white/20">
                  ...
                  <span className="text-emerald-400">{((f.magnitude || 0) * 20).toFixed(1)}% COEFFICIENT</span>
               </div>
            ...
            <div className="flex items-center gap-2 md:gap-6 px-2 md:px-4">
              ...
              <div className="flex flex-col items-center justify-center p-2 md:p-3 rounded-full bg-white/5 border border-white/5 group-hover:scale-110 transition-all shadow-[0_0_15px_rgba(45,212,191,0.1)] shrink-0">
                <Swords className="w-3 h-3 md:w-4 md:h-4 text-white/20 group-hover:text-emerald-400 transition-colors" />
              </div>
  ...
  return (
    <div className="min-h-screen bg-[#02040A] relative overflow-hidden flex items-center justify-center p-6 perspective-[1500px]">
      ...
      <motion.div 
        ...
        className="relative z-10 w-full max-w-6xl tactical-glass border-emerald-500/20 rounded-[2rem] md:rounded-[3rem] shadow-[0_0_150px_rgba(0,0,0,0.8)] flex flex-col md:flex-row min-h-[80vh] max-h-[95vh] overflow-hidden"
      >
        {/* Global HUD Accents */}
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-20">
           <div className="hud-corner hud-corner-tl" />
        ...
        >
          <div className="flex items-center gap-4 mb-8 md:mb-20">
            <div className="w-12 h-12 rounded-[1.25rem] bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-black shadow-lg shadow-emerald-500/30">
              <Zap className="w-7 h-7" />
            </div>
            <div>
              <h1 className="text-2xl font-black italic tracking-tighter text-white leading-none drop-shadow-md">CUSTOM</h1>
              <p className="text-[10px] text-emerald-400/80 font-black uppercase tracking-widest mt-1 flex items-center gap-1.5">
          ...
          <div className="space-y-4 md:space-y-6 flex-1 hidden md:block">
            {[1, 2, 3, 4].map(s => (
              <div key={s} className="flex items-center gap-6 group cursor-pointer" onClick={() => s < step && setStep(s)}>
                <div className={`w-1.5 h-12 rounded-full transition-all duration-500 ${step === s ? 'bg-emerald-500 shadow-[0_0_15px_rgba(45,212,191,0.5)]' : s < step ? 'bg-emerald-400/30' : 'bg-white/5'}`} />
                <div>
          ...
          {step < 4 && (
            <div className="mt-8 md:mt-12 flex justify-between items-center border-t border-white/5 pt-6 md:pt-12 relative z-[60] shrink-0">
              ...
              <button 
                ...
                className="px-6 md:px-10 py-3 md:py-4 rounded-2xl bg-emerald-500 text-black font-black uppercase text-xs tracking-widest hover:bg-emerald-400 shadow-[0_0_30px_rgba(45,212,191,0.4)] transition-all flex items-center gap-2 md:gap-3 cursor-pointer relative z-[70]"
              >
            ...
            <div className="absolute inset-0 tactical-glass flex flex-col items-center justify-center z-[100] rounded-[3rem] p-12 overflow-hidden">
               ...
               <div className="relative mb-12">
                  <motion.div 
                    ...
                    className="w-40 h-40 rounded-full border-4 border-emerald-500/10 border-t-emerald-500 shadow-[0_0_80px_rgba(45,212,191,0.4)]"
                  />
                  <Zap className="absolute inset-0 m-auto w-12 h-12 text-emerald-400 animate-pulse drop-shadow-[0_0_20px_rgba(45,212,191,1)]" />
                  ...
                  <div className="bg-black/60 border border-white/10 rounded-2xl p-6 h-48 overflow-hidden relative">
                    ...
                    <div className="space-y-2">
                       {commandLog.map((log, i) => (
                         ...
                         >
                           <span className="text-[10px] text-emerald-500/40 font-mono">[{new Date().toLocaleTimeString()}]</span>
                           <span className="text-[10px] text-emerald-400 font-black tracking-widest uppercase">{log.text}</span>
                         </motion.div>
                       ))}
                    </div>
                  </div>
